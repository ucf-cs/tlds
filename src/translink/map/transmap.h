...
public:
 ...
 //    };
  ...
  //   };
	...
	TransMap(/*Allocator<Node>* nodeAllocator,*/ Allocator<TransMap::Desc>* descAllocator, Allocator<TransMap::NodeDesc>* nodeDescAllocator, uint64_t initalPowerOfTwo, uint64_t numThreads)
...
// private:
	...
	//TODO: have execute ops take a reference to a vector and pass that to helpops to use for the foundvalues to be returned?



    // //void HelpOps(Desc* desc, uint8_t opid);
    // //inline std::vector<VALUE> HelpOps(Desc* desc, uint8_t opid, int threadId);
