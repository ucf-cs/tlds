...
Completed operations will not be affected should a later operation in the transaction experiences contention and needs to retry (most lock-free data structures use CAS-based retry loops). 
