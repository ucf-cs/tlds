...
\title{Lock-free Transactions with Minimal Aborts for Linked Data Structures}
...
Each threads performs 1 million transactions and the key range is set up to 10 thousand.
