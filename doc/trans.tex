...
Obstruction-free transactional transformation allows dynamic transaction executions by adopting aggressive contention management (i.e., the later transaction always forcibly aborts the conflicting transaction).
...
This approach eliminates the need for the helping mechanism while preserving serialization.
...
In Algorithm~\ref{alg:obstructionfreetransaction}, we list the methods of the obstruction-free methodology for transaction execution.
